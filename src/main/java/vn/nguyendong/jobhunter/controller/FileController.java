...
import vn.nguyendong.jobhunter.domain.response.file.ResponseUploadFileDTO;
import vn.nguyendong.jobhunter.service.FileService;
import vn.nguyendong.jobhunter.util.annotation.ApiMessage;
import vn.nguyendong.jobhunter.util.error.StorageException;

@RestController
@RequestMapping("/api/v1")
public class FileController {

    @Value("${nguyendong.upload-file.base-uri}")
