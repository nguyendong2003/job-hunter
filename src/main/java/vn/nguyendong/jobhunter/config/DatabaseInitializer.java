...
import vn.nguyendong.jobhunter.repository.PermissionRepository;
import vn.nguyendong.jobhunter.repository.RoleRepository;
import vn.nguyendong.jobhunter.repository.UserRepository;
import vn.nguyendong.jobhunter.util.constant.GenderEnum;

// File này để tạo dữ liệu mẫu cho database
@Service
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Đếm record trong các bảng để kiểm tra xem đã có dữ liệu chưa, nếu chưa có mới
        // tạo dữ liệu mẫu
